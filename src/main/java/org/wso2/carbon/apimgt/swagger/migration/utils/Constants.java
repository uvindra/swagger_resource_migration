...
public final class Constants {
	...
	public static final String API_DOC_11_PARAM_NAME = "name";
	public static final String API_DOC_11_PARAM_TYPE = "paramType";
	...
	public static final String API_DOC_12_PARAM_NAME = "name";
	public static final String API_DOC_12_PARAM_TYPE = "paramType";
    ...
    //------------------------------------------
    public static final String API_DOC_11_DATA_TYPE = "dataType";
    public static final String API_DOC_12_DATA_TYPE = "type";
